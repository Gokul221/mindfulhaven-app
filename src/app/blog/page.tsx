                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                            {posts.map((post) => (
                                <Link key={post.id} href={`/blog/${post.slug}`}>
                                    <Card
                                        className="gradient-card shadow-card hover:shadow-soft transition-smooth cursor-pointer hover-scale group h-full"
                                    >
